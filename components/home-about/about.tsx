            ...
            <>
              ...
              <div className="fade-in-down">
                <p className="text-sm font-medium text-primary uppercase tracking-widest">
                  Experiência em Construções LSF e Madeira
                </p>
              </div>
              ...
              <h1 className="fade-in text-5xl sm:text-6xl lg:text-7xl font-serif font-bold text-foreground leading-tight text-balance">
                Design que eleva
                <br />
                <span className="text-primary">Inovação que transforma</span>
              </h1>

              {/* Description */}
              <p className="fade-in-up text-lg sm:text-xl text-foreground/70 max-w-2xl mx-auto leading-relaxed text-balance">
                Projectos á medida com modernidade, eficiência e precisão.
                Design elegante e construção de alto nível em cada etapa.
              </p>
